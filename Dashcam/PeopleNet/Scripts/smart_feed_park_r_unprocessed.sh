...
# Smart Feed for Park_R Unprocessed (678 videos from Oct 28 - Nov 13)
# Processing rate: ~13 videos/min
# Feed rate: 10 videos/min (safety margin)

VIDEO_LIST="/home/yousuf/PROJECTS/PeopleNet/park_r_unprocessed.txt"
STAGING_DIR="/home/yousuf/PROJECTS/PeopleNet/Staging/Park_R_Unprocessed"
PROCESSED_LIST="/home/yousuf/PROJECTS/PeopleNet/Outputs/Park_R_Unprocessed/processed_videos.txt"
OUTPUT_DIR="/home/yousuf/PROJECTS/PeopleNet/Outputs/Park_R_Unprocessed"
...
echo "========================================"
echo "Smart Feed - Park_R Unprocessed"
echo "========================================"
...
echo ""
echo "$(date +%H:%M:%S) Smart feed complete for Park_R Unprocessed!"
